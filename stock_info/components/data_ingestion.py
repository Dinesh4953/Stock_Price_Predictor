...
from stock_info.entity.config_entity import DataIngestionConfig
from stock_info.entity.artifact_entity import DataIngestionArtifact
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe:pd.DataFrame):
        try:
            ...
            logging.info(
                "Exited split_data_as_test method of Data Ingestion class"
            )
